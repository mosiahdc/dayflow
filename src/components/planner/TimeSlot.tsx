      ...
      <div className="flex-1 relative">
        ...
        {!showForm && startingTasks.length === 0 && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-300 hover:text-brand-accent opacity-0 group-hover:opacity-100 transition-opacity text-lg leading-none"
